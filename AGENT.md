...
## Objective
Maintain `support-agent-saas` as a reliable, useful, and test-first project aligned with its primary promise:
> Support automation SaaS template with KB upload, widget, analytics, and escalation queue.
